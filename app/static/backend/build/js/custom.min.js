...
function init_daterangepicker() {
    if ("undefined" != typeof $.fn.daterangepicker) {
        ...
        $("#reportrange span").html(moment().format("MM-DD-YYYY") + " - " + moment().format("MM/DD/YYYY")), $("#reportrange").daterangepicker(b, a), $("#reportrange").on("show.daterangepicker", function () {
            console.log("show event fired")
        }), $("#reportrange").on("hide.daterangepicker", function () {
            console.log("hide event fired")
        }), $("#reportrange").on("apply.daterangepicker", function (a, b) {
            console.log("apply event fired, start/end dates are " + b.startDate.format("MM/DD/YYYY") + " to " + b.endDate.format("MM/DD/YYYY"))
