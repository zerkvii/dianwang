...
(function(window, document, Chartist) {
  ...
  /**
   * Simple smoothing creates templates handles that are positioned with a fraction of the length between two data points. You can use the divisor option to specify the amount of smoothing.
   *
  ...
  function createGridAndLabels(gridGroup, labelGroup, useForeignObject, chartOptions, eventEmitter) {
    ...
    projectedValues.forEach(function(projectedValue, index) {
      ...
      if(this.units.pos === 'x') {
        ...
        // If the labels should be positioned in start position (left side for templates axis) we need to set a
...
(function(window, document, Chartist){
  ...
  var defaultOptions = {
    ...
    axisX: {
      ...
      offset: 30,
      // Position where labels are placed. Can be set to `start` or `end` where `start` is equivalent to left or top on vertical axis and `end` is equivalent to right or bottom on templates axis.
      position: 'end',
...
(function(window, document, Chartist){
  ...
  var defaultOptions = {
    ...
    // Inverts the axes of the bar chart in order to draw a templates bar chart. Be aware that you also need to invert your axis settings as the Y Axis will now display the labels and the X Axis the values.
    ...
    classNames: {
      chart: 'ct-chart-bar',
      horizontalBars: 'ct-templates-bars',
      label: 'ct-label',
      labelGroup: 'ct-labels',
      series: 'ct-series',
      bar: 'ct-bar',
