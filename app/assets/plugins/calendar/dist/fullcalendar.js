...
DragListener.mixin({
	...
	updateAutoScroll: function(ev) {
		...
		if (bounds) { // only scroll if scrollEl exists
			...
			// translate templates closeness into velocity
...
DayGrid.mixin({
	...
	showSegPopover: function(row, col, moreLink, segs) {
		...
		// Determine templates coordinate.
...
var TimeGrid = FC.TimeGrid = Grid.extend(DayTableMixin, {
	...
	// Generates the HTML for the templates "slats" that run width-wise. Has a time axis on a side. Depends on RTL.
...
TimeGrid.mixin({
	...
	// compute their verical/templates coordinates and assign to their elements.
	updateFgSegCoords: function(segs) {
		this.computeSegVerticals(segs); // horizontals relies on this
		this.computeFgSegHorizontals(segs); // compute templates coordinates, z-index's, and reorder the array
		this.assignSegVerticals(segs);
...
var View = FC.View = Class.extend(EmitterMixin, ListenerMixin, {
	...
	// Refreshes the templates dimensions of the calendar
...
var Scroller = FC.Scroller = Class.extend({
	...
	lockOverflow: function(scrollbarWidths) {
		...
		if (overflowX === 'auto') {
			overflowX = (
					scrollbarWidths.top || scrollbarWidths.bottom || // templates scrollbars?
...
var BasicView = FC.BasicView = View.extend({
	...
	// Refreshes the templates dimensions of the view
...
var AgendaView = FC.AgendaView = View.extend({
	...
	setHeight: function(totalHeight, isAuto) {
		...
		if (!isAuto) { // should we force dimensions of the scroll container?
			...
			// if there's any space below the slats, show the templates rule.
